{
            ...
            "parameters": [
                {
                    "meta": {
                        "validation": {
                            "required": true,
                            "requiredDetail": {
                                "errorMsg": "Please add the API key as it cannot be empty"
                            }
                        },
                        "description": "Your Linkedin API Key. Navigate to the <a href='https://www.linkedin.com/developers/tools/oauth/token-generator?clientId=77klpugw1fujy1' target='_blank'> LinkedIn API documentation </a> for more details.",
                        "displayName": "API Key",
    ...
    "created_at": "2025-06-11T12:12:47.407Z",
    "updated_at": "2025-06-11T12:12:47.407Z"
}